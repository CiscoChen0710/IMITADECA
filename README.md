...
please make sure to download all the necessary files for both models into your local directory. Since the pipeline involves data exchange and interaction between the two models, failing to download both sets of files may lead to errors or unexpected behavior.
